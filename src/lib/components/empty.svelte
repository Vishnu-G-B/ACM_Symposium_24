<script>
	...
	export let errorText, errorPara, errorLink,errorLinkText;
</script>
...
<section class="error">
	...
	<div class="error__content">
		<div class="error__message message sm:!mt-[10rem]">
			<h1 class="message__title" style="color: white;">{errorText}</h1>
			<p class="message__text" >
                {errorPara}
            </p>
		</div>
		<div class="w-full h-fit flex justify-center items-center !mt-4">
			<a class="fancy" href="{errorLink}">
				<span class="top-key"></span>
				<span class="text">{errorLinkText}</span>
